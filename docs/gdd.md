...
| Budget | How It Works |
|---|---|
| **Zone Budget** | Each pitcher card has a tendency percentage per zone (e.g. High-Away: 30%, Mid-Inside: 25%). Budget tracks actual usage across the game. Overuse triggers Zone Fatigue: -25% effectiveness in that zone, and the AI batter's model flags it as high-probability. Budget resets on reliever entry. |
...
Contact quality is determined entirely by how accurately the batter predicted zone and pitch type.

| Prediction Result | Contact Quality | Effect on Resolution |
|---|---|---|
| **Both Correct** | Full Contact | Complete dice pool. Hot zone bonus applies (+1 die if in batter's wheelhouse). Best possible ball flight outcomes available. |
| **Zone Correct / Type Wrong** | Timing Disruption | Dice pool -1 die. Ball still put in play but hit quality reduced. Power outcomes less likely. |
| **Type Correct / Zone Wrong** | Off-Balance Contact | Dice pool -2 dice. Weak contact. Mostly foul balls and soft outs. Occasional lucky hit on high-Average batters. |
| **Both Wrong** | No Contact | No dice pool. Result: ball or strike based purely on whether selected zone was in the strike zone. Batter did not swing — count advances. |
...
### 5.10 The Reliever — Information Reset
...
- Card system built: Card.jsx with 4 era fronts, CardExpanded.jsx landscape overlay (900×500px), portal-based
...
- At-bat engine: NOT YET BUILT — start here
- Zustand stores: NOT YET BUILT
- Roster/season screens: NOT YET BUILT

---

*⬦ DIAMOND LEGENDS ⬦ — Game Design Document · v1.3 · March 2026*
